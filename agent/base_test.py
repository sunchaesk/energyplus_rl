#NOTE: base_temp removes all exogeneous states to see how fast the model converges to maximum setpoint temperature
...
class EnergyPlusRunner:
    ...
    def _send_actions(self, state_argument):
        ...
        next_action = self._rescale(next_action, -1, 1, 18, 25)
        # print('######')
...
class EnergyPlusEnv(gym.Env):
    ...
    def __init__(self, env_config: Dict[str, Any]):
        ...
        self.action_space: Box = Box(np.array([18]), np.array([25]), dtype=np.float32)
