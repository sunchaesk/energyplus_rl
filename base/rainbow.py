...
def save_reward(reward: float) -> None:
    ...
    with open(f_name, 'a') as score_f:
        score_f.write(str(reward) + '\n')
    ...
    for i in range(episode):
        ...
        while True:
            ...
            if done:
                ...
                save_reward(reward_total)
                graphing(cooling_setpoints, cost_signals, outdoor_temperatures, indoor_temperatures, episode=i)
                break
